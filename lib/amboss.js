...
async function fetchNodestrichStats(apiKey = null) {
  try {
    ...
    // Log the full response to understand the schema
    console.log('Amboss API response:', JSON.stringify(data, null, 2));

    // For now, return the schema info and still use fallback data
    return {
      memberCount: 299,
      totalChannels: 6181,
      totalCapacity: 611.5,
      ...
      source: 'Amboss.space (schema test)',
      schemaResponse: data
    };
